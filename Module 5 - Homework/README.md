...
- [Question 1. Bruin Pipeline Structure](#question-1-bruin-pipeline-structure)
- [Question 2. Materialization Strategies](#question-2-materialization-strategies)
- [Question 3. Pipeline Variables](#question-3-pipeline-variables)
- [Question 4. Running with Dependencies](#question-4-running-with-dependencies)
- [Question 5. Quality Checks](#question-5-quality-checks)
- [Question 6. Lineage and Dependencies](#question-6-lineage-and-dependencies)
- [Question 7. First-Time Run](#question-7-first-time-run)

## Overview - End-to-End Data Platform

See the [Overview - End-to-End Data Platform](#overview---end-to-end-data-platform) section below for a high-level description of the NYC Taxi ELT project and its learning goals.
